...
def to_source_id(txid, chain):
    if chain == Chain.bitcoin_mainnet or Chain.bitcoin_testnet or Chain.ethereum_mainnet or Chain.ethereum_ropsten or Chain.ethereum_goerli or Chain.ethereum_gusandbox or Chain.ethereum_joc:
        return txid
    else:
