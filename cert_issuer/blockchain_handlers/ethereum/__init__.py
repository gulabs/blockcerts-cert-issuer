...
def instantiate_blockchain_handlers(app_config):
    ...
    # ethereum chains
    elif chain == Chain.ethereum_mainnet or chain == Chain.ethereum_ropsten or chain == Chain.ethereum_goerli or chain == Chain.ethereum_gusandbox or chain == Chain.ethereum_joc:
